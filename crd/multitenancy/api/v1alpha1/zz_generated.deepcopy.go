...
func (in *NICNetworkConfigList) DeepCopyInto(out *NICNetworkConfigList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NICNetworkConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NICNetworkConfigList) DeepCopy() *NICNetworkConfigList {
	if in == nil {
		return nil
	}
	out := new(NICNetworkConfigList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NICNetworkConfigSpec) DeepCopyInto(out *NICNetworkConfigSpec) {
	*out = *in
	if in.PodAllocationRequests != nil {
		...
		*out = make([]PodAllocationRequest, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NICNetworkConfigSpec.
func (in *NICNetworkConfigSpec) DeepCopy() *NICNetworkConfigSpec {
	if in == nil {
		return nil
	}
	out := new(NICNetworkConfigSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NICNetworkConfigStatus) DeepCopyInto(out *NICNetworkConfigStatus) {
	*out = *in
	...
	if in.PodAllocations != nil {
		in, out := &in.PodAllocations, &out.PodAllocations
		*out = make(map[string]PodAllocation, len(*in))
...
func (in *NICNetworkConfigStatus) DeepCopy() *NICNetworkConfigStatus {
	if in == nil {
		return nil
	}
	out := new(NICNetworkConfigStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodAllocationRequest) DeepCopy() *PodAllocationRequest {
	if in == nil {
		return nil
	}
	out := new(PodAllocationRequest)
	in.DeepCopyInto(out)
	return out
}
